...
const pricingTiers = [
  {
    ...
    description: 'Get equipment and inventory under control fast.',
    features: ['Unlimited users', 'Unlimited work orders', 'Equipment records + maintenance history', 'Parts + inventory tracking', 'Photo issue reporting', 'Offline-friendly mobile workflows'],
  ...
  },
  {
    ...
    description: 'Add preventive scheduling and stronger reporting.',
    features: ['Everything in Starter', 'Equipment health dashboard', 'Preventive maintenance scheduler', 'Low-stock alerts + usage logs', 'Recurring work automation', 'Advanced operational reporting'],
    cta: 'See Pro in Action',
    href: '/book-demo',
    featured: true
  },
  {
    ...
    fit: 'Best for multi-site teams',
    description: 'Centralized visibility, controls, and integrations.',
